...
\providecommand{\hhdocumentpagecount}{\pageref{lastReportPage}}
...
\newcommand{\hhheaderpagecount}{\pageref{lastReportPage}}
...
\ifthenelse{\equal{\hhtemplatetype}{short}}{
  ...
  \fancypagestyle{hh-template-header-footer}{
    ...
    \rhead{\thepage (\hhheaderpagecount)\\\ \\\ \\\hhdocumentdate}
  }
}
{ % long and thesis
