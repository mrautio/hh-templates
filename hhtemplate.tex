...
\newtranslation[to = british]{thesisname}{Report/thesis title}
...
\newtranslation[to = british]{appendixpagecount}{appendix pages}
...
\newtranslation[to = british]{orientation}{Degree programme}
