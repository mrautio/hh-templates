...
\providecommand{\hhdocumentnumberofappendices}{$if(hhdocumentnumberofappendices)$$hhdocumentnumberofappendices$$else$$if(hhdocumentappendixpagecount)$$hhdocumentappendixpagecount$$else$0$endif$$endif$}
...
\ifthenelse{\equal{\hhtemplatetype}{thesis}}{
  ...
  \vspace{-1pt}\fbox{\begin{minipage}[l][4em][t]{\dimexpr(\textwidth-4.5cm)}\textbf{\translate{thesisname}}\\\ \\\hhdocumenttitle\end{minipage}}\hspace{-1pt}\fbox{\begin{minipage}[l][4em][t]{4.3cm}\textbf{\translate{pagecount} +\\\translate{numberofappendices}}\\ \hhdocumentpagecount\ + \hhdocumentnumberofappendices\end{minipage}}
