...
\providecommand{\hhreportlanguage}{$if(hhreportlanguage)$$hhreportlanguage$$else$finnish$endif$}
...
\providecommand{\hhdocumentauthor}{$author$}
\providecommand{\hhdocumenttitle}{$title$}
\providecommand{\hhdocumentkeywords}{$if(hhdocumentkeywords)$$hhdocumentkeywords$$else$\ $endif$}
...
\newtranslation[to = english]{thesis}{Master thesis}
\newtranslation[to = finnish]{thesis}{Master opinnäytetyö}
}
{ % BBA
\newtranslation[to = english]{thesis}{Thesis}
\newtranslation[to = finnish]{thesis}{Opinnäytetyö}
}

\newtranslation[to = english]{report}{Report}
\newtranslation[to = finnish]{report}{Raportti}
\newtranslation[to = english]{assignmentreport}{Report}
\newtranslation[to = finnish]{assignmentreport}{Harjoitustyöraportti}
\newtranslation[to = english]{toctitle}{Contents}
...
\newtranslation[to = english]{authors}{Author(s)}
\newtranslation[to = finnish]{authors}{Tekijä(t)}
\newtranslation[to = english]{thesisname}{Thesis title}
\newtranslation[to = finnish]{thesisname}{Opinnäytetyön nimi}
\newtranslation[to = english]{pagecount}{Pages}
\newtranslation[to = finnish]{pagecount}{Sivumäärä}
\newtranslation[to = english]{appendixpagecount}{Appendix pages}
\newtranslation[to = finnish]{appendixpagecount}{liitesivumäärä}
\newtranslation[to = english]{keywords}{Key words}
\newtranslation[to = finnish]{keywords}{Asiasanat}
\newtranslation[to = english]{orientation}{Orientation}
\newtranslation[to = finnish]{orientation}{Suuntautuminen}
\newtranslation[to = english]{abbreviations}{Abbreviations}
\newtranslation[to = finnish]{abbreviations}{Lyhenteet}
\newtranslation[to = english]{hhfullname}{Haaga-Helia University of Applied Sciences}
